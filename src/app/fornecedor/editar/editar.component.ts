...
export class EditarComponent extends FormBaseComponent implements OnInit {
  ...
  editarFornecedor() {
    if (this.fornecedorForm.dirty && this.fornecedorForm.valid) {
      ...
      this.toastr.info('Ops! Parece que nada mudou por aqui. Tudo está como estava antes. 😊');
    }
  }
  ...
  processarSucesso(response: any) {
    ...
    //   });
    // }
    this.router.navigate(['/fornecedores/listar-todos']).then(() => {
      this.toastr.success('Que ótimo! O fornecedor foi atualizado com sucesso! 🎉', 'Sucesso! 😃');
    });
  }
